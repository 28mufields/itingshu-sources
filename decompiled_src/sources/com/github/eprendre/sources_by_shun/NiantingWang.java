...
public final class NiantingWang extends TingShu implements CoverUrlExtraHeaders, AudioUrlExtraHeaders {
    ...
    public Pair<List<Book>, Integer> search(String keywords, int page) {
        ...
        String url = "https://www.nianyin.com/?s=ting-search-wd-" + URLEncoder.encode(keywords, "utf8") + "-p-" + page + ".html";
        Connection connect = Jsoup.connect(url);
        Intrinsics.checkNotNullExpressionValue(connect, "connect(url)");
        Document doc = MyExtKt.config(connect, true).headers(MapsKt.mapOf(TuplesKt.to("referer", "https://www.nianyin.com/"))).get();
    ...
    public AudioUrlExtractor getAudioUrlExtractor() {
        AudioUrlWebViewExtractor.setUp$default(AudioUrlWebViewExtractor.INSTANCE, true, (String) null, new Function1<String, String>() { // from class: com.github.eprendre.sources_by_shun.NiantingWang$getAudioUrlExtractor$1
    ...
    public List<CategoryMenu> getCategoryMenus() {
        Connection connect = Jsoup.connect("https://www.nianyin.com/");
        Intrinsics.checkNotNullExpressionValue(connect, "connect(url)");
    ...
    public boolean coverHeaders(String coverUrl, Map<String, String> headers) {
        ...
        headers.put("referer", "https://www.nianyin.com/");
        return true;
    }
}
